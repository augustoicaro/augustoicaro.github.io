...
(function ($, window, undefined) {
  ...
  $.PFold.prototype = {
    _init: function (options) {
      ...
      console.debug("PFOLD 3D support: %s", this.support);
    ...
    _getTranslationViewport: function () {
      ...
      if (this.options.centered) {
        ...
        case "english-visible":
          console.debug("O do scroll eh: %s", document.getElementById("english").scrollTop);
          fty = fty - (fty - 80) - (this.initialDim.offsetT - 265) - document.getElementById("english").scrollTop;
          break;
        case "portuguese-visible":
          console.debug("O do scroll eh: %s", document.getElementById("portuguese").scrollTop);
          fty = fty - (fty - 80) - (this.initialDim.offsetT - 265) - document.getElementById("portuguese").scrollTop;
          break;
        case "spanish-visible":
          console.debug("O do scroll eh: %s", document.getElementById("spanish").scrollTop);
          fty = fty - (fty - 80) - (this.initialDim.offsetT - 265) - document.getElementById("spanish").scrollTop;
          break;
        }

        console.debug("Retornando: %s, %s", ftx, fty);
      }

      return {
        ftx: document.getElementById("side").offsetWidth,
        fty: fty + 3
      };
